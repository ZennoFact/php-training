...
<body>
    ...
    <form enctype="multipart/form-data" action="./signup.php" method="post">
        ...
        <!-- MAX_FILE_SIZE は、必ず "file" input フィールドより前に設定（サイズはバイト）今回は400kバイト -->
        ...
        <p>※画像は任意です，128px×128pxのサイズで用意してください。</p><!-- 今回は -->
